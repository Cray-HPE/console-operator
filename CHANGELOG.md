...
- Bump `actions/checkout` from 4 to 7 ([#110](https://github.com/Cray-HPE/console-operator/pull/110))
- Bump `golang.org/x/crypto` from 0.36.0 to 0.52.0 ([#113](https://github.com/Cray-HPE/console-operator/pull/113))
- Bump `golang.org/x/net` from 0.38.0 to 0.54.0 ([#113](https://github.com/Cray-HPE/console-operator/pull/113))
- Bump `golang.org/x/oauth2` from 0.23.0 to 0.27.0 ([#113](https://github.com/Cray-HPE/console-operator/pull/113))
